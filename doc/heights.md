...
| ------------------------ | ------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| FLARM                    | Altitude above WGS-84 Ellipsoid                         | Some sources say Height Above Ellipsoid, however OGN Stations seem to indicate MSL?? |
| OGN                      | Altitude above Geoid (MSL)                              |                                                                                     |
| ADS-L                    | ADS-L.4.SRD860.G.1.7 Altitude above WGS-84 Ellipsoid    |                                                                                     |
| FANET                    | Altitude above Geoid (MSL)                              |                                                                                     |
| ADS-B (online)           | Ellipsoid WGS84 or Barometric, when QNH if available    | When barometric is known, math is applied to estimate WGS-84 Ellipsoid            |
...
For GA/TAS, GGA messages we use altitude MSL and the geoid height
...
Internally all altitudes are converted to Height Above Ellipsoid, this makes it far easier to show relative altitudes and have correct estimates if a plane in distance is above or below us.
