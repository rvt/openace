...
// @todo get this from somwhere else
...
#if !defined(PICO_RP2040)
#define LIBCRCPROGMEM PROGMEM
#define LIBCRCINFLASH 
#endif

#if defined(PICO_RP2040)
#define LIBCRCPROGMEM
#define LIBCRCINFLASH  __in_flash()
#endif

#if !defined(ESP8266) && !defined(__ASR6501__) && \
    !defined(ENERGIA_ARCH_CC13XX) && !defined(ENERGIA_ARCH_CC13X2) && \
    !defined(ARDUINO_ARCH_STM32) && !defined(PICO_RP2040)
static unsigned short crc_tabccitt[256];
#else
static const unsigned short LIBCRCINFLASH crc_tabccitt[256] LIBCRCPROGMEM =
{
...
// static constexpr unsigned char LIBCRCINFLASH crc8_table[256]
// #if defined(ESP8266) || defined(ESP32) || defined(__ASR6501__) || 
//     defined(ENERGIA_ARCH_CC13XX) || defined(ENERGIA_ARCH_CC13X2) || 
//     defined(ARDUINO_ARCH_STM32)
// LIBCRCPROGMEM
