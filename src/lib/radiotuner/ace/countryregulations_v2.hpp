...
public:
    ...
    static constexpr Radio::ProtocolConfig PROTOCOL_NONE{1, GATAS::Modulation::NONE, GATAS::DataSource::ADSL, 0, 16, 8, {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}};           // NONE
    // Wtih this configuration I can receive, but not send RP2040 and RP2350
//    static constexpr Radio::ProtocolConfig PROTOCOL_FLARM{2, GATAS::Modulation::GFSK, GATAS::DataSource::FLARM, 26, 16, 7, {/*0x55,*/ 0x99, 0xA5, 0xA9, 0x55, 0x66, 0x65, 0x96, 0x00}}; // 0 FLARM 0 airtime 6ms

    // This way sending works perfectly from RP2040 to LilyGo
//    static constexpr Radio::ProtocolConfig PROTOCOL_FLARM{2, GATAS::Modulation::GFSK, GATAS::DataSource::FLARM,  26, 16, 8, {0x55, 0x99, 0xA5, 0xA9, 0x55, 0x66, 0x65, 0x96}};     // 0 FLARM 0 airtime 6ms    
    // This way sending works perfectly from RP2040 to LilyGo
    static constexpr Radio::ProtocolConfig PROTOCOL_FLARM{2, GATAS::Modulation::GFSK, GATAS::DataSource::FLARM,  26, 16, 8, {0x55, 0x99, 0xA5, 0xA9, 0x55, 0x66, 0x65, 0x96}};       // 0 FLARM 0 airtime 6ms    
    static constexpr Radio::ProtocolConfig PROTOCOL_OGN1 {3, GATAS::Modulation::GFSK, GATAS::DataSource::OGN1,   26, 16, 8, {0xAA, 0x66, 0x55, 0xA5, 0x96, 0x99, 0x96, 0x5A}};       // 1 OGN 1 airtime 6ms <- This seems to be in use 20 Byte packet length :: 6 byte CRC
    static constexpr Radio::ProtocolConfig PROTOCOL_ADSL {4, GATAS::Modulation::GFSK, GATAS::DataSource::ADSL,   24, 16, 8, {0x55, 0x99, 0x95, 0xA6, 0x9A, 0x65, 0xA9, 0x6A}};       // 3 ADSL == SYNC  0x72 0x4B = Manchester 0x95, 0xA6, 0x9A, 0x65. 0x99 is required as a preamble to be send and rge length is included as sync because it's fixed to 0x18
    static constexpr Radio::ProtocolConfig PROTOCOL_PAW  {5, GATAS::Modulation::GFSK, GATAS::DataSource::PAW,    00, 16, 8, {0xB4, 0x2B, 0x00, 0x00, 0x00, 0x00, 0x18, 0x71}};       // 4 PAW
    static constexpr Radio::ProtocolConfig PROTOCOL_FANET{6, GATAS::Modulation::LORA, GATAS::DataSource::FANET, 255, 12, 2, {0xF4, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};       // 5 FANET
    ...
    static constexpr __in_flash() etl::array<const ProtocolTimeSlot, 9> protocolTimimgs{
        ProtocolTimeSlot{1, CountryRegulations::Zone::ZONE0, Europe, PROTOCOL_NONE,      {Channel::NOP, Channel::NOP, Channel::NOP, Channel::NOP, Channel::NOP},  000, 0000, 00, 000},
        ProtocolTimeSlot{2, CountryRegulations::Zone::ZONE1, Europe, PROTOCOL_FLARM,     {Channel::CH1, Channel::NOP, Channel::CH0, Channel::CH0, Channel::CH1},  600, 1400, 15, 150},
        ProtocolTimeSlot{3, CountryRegulations::Zone::ZONE1, Europe, PROTOCOL_OGN1,      {Channel::CH0, Channel::NOP, Channel::CH1, Channel::CH1, Channel::CH0},  600, 1400, 15, 150},
        ProtocolTimeSlot{4, CountryRegulations::Zone::ZONE1, Europe, PROTOCOL_ADSL,      {Channel::CH0, Channel::NOP, Channel::CH1, Channel::CH1, Channel::CH0},  600, 1400, 15, 250},
        ProtocolTimeSlot{5, CountryRegulations::Zone::ZONE1, Europe, PROTOCOL_FANET,     {Channel::CH0, Channel::CH0, Channel::CH0, Channel::CH0, Channel::CH0}, 2000, 3000, 15, 000},

        ProtocolTimeSlot{6, CountryRegulations::Zone::ZONE5, Israel, PROTOCOL_FLARM,     {Channel::CH1, Channel::NOP, Channel::CH0, Channel::CH0, Channel::CH1}, 600, 1400, 15, 150},

        // New Zeland not tested
        ProtocolTimeSlot{7, CountryRegulations::Zone::ZONE3, NewZealand, PROTOCOL_FLARM, {Channel::CH1, Channel::NOP, Channel::CH0, Channel::CH0, Channel::CH1},  600, 1400, 15, 150},
        ProtocolTimeSlot{8, CountryRegulations::Zone::ZONE3, NewZealand, PROTOCOL_OGN1,  {Channel::CH0, Channel::NOP, Channel::CH1, Channel::CH1, Channel::CH0},  600, 1400, 15, 150},
        ProtocolTimeSlot{9, CountryRegulations::Zone::ZONE1, Europe, PROTOCOL_FANET,     {Channel::CH0, Channel::CH0, Channel::CH0, Channel::CH0, Channel::CH0}, 2000, 3000, 15, 000},
    };
    // clang-format on
private:
...
public:
     ...
     */
    static const CountryRegulations::ProtocolTimeSlot &getSlot(CountryRegulations::Zone zone, GATAS::DataSource dataSource);
     ...
     * @return uint32_t 
     */
    static uint32_t nextRandomTime(const CountryRegulations::ProtocolTimeSlot& pts);
};
