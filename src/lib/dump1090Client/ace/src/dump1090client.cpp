...
void Dump1090Client::processNewSentence(etl::span<uint8_t> data)
{
    ...
    GATAS_ASSERT(GATAS::ADSBMessageBinMsg::MAX_BINARY_LENGTH * 2 == ADSBDATALENGTH, "Must be equal");
    ...
    if (sentence[1] == '8' && (sentence[2] == 'D' || sentence[2] == 'A' || sentence[2] == '0'))
    {
        ...
        {
            GATAS::ADSBMessageBinMsg msg;
            CoreUtils::hexStrToByteArray(sentence.cbegin() + 1, GATAS::ADSBMessageBinMsg::MAX_BINARY_LENGTH*2, msg.data);
