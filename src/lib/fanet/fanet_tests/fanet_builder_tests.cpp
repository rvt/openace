...
TEST_CASE("PacketBuilder ACK signature", "[single-file]")
{
    ...
    etl::vector<uint8_t, 12> expected = {0x80, 0x12, 0x56, 0x34, 0x30, 0x98, 0x54, 0x76, 0x32, 0x54, 0x76, 0x98};
                                         0x80, 0x12, 0x56, 0x34, 0x30, 0x98, 0x54, 0x76, 0x32, 0x54, 0x76, 0x98, 0x00,

    dumpHex(pb.build(AckPayload{}));

    printf("Expected: %ld", sizeof(AckPayload));
...
//     // 0x01, 0x12, 0x56, 0x34, 0xC0, 0x0E, 0x13, 0xD9, 0x30, 0x25, 0x00, 0x00, 0x5B, 0x00, 0x00, 0x00,
//     // dumpHex(pb.build(tp));

    
//     pb.setSignature(0x98765432);
//     // 0x81, 0x12, 0x56, 0x34, 0x30, 0x32, 0x54, 0x76, 0x98, 0xC0, 0x0E, 0x13, 0xD9, 0x30, 0x25, 0x00, 0x00, 0x5B, 0x00, 0x00, 0x00, 
//     // dumpHex(pb.build(tp));


//     pb.setDestination(Address{0x345678});
//     // 0x81, 0x12, 0x56, 0x34, 0x30, 0x34, 0x78, 0x56, 0x32, 0x54, 0x76, 0x98, 0xC0, 0x0E, 0x13, 0xD9, 0x30, 0x25, 0x00, 0x00, 0x5B, 0x00, 0x00, 0x00, 
//     // dumpHex(pb.build(tp));
// }
